...
The slice excludes egg cracking, stamping, chopping, additional vignettes, endless mode, procedural rhythms, a song library, multiplayer, physics simulation, asset editors and monetization. Its purpose is to prove that repeating rhythms through changing physical jokes is satisfying and technically reliable.
